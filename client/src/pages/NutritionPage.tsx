      ...
      <div className="glow-border rounded-xl bg-card p-5 fade-slide-up stagger-2" data-testid="nutrition-chart">
        ...
        <ResponsiveContainer width="100%" height={220}>
          <BarChart data={chartData} margin={{ top: 4, right: 8, bottom: 0, left: -16 }} barSize={28}>
            ...
            <Tooltip content={<NutritionTooltip />} cursor={{ fill: "hsl(var(--secondary))" }} wrapperStyle={{ background: "hsl(var(--card))", border: "1px solid hsl(var(--border))", borderRadius: "8px", boxShadow: "0 4px 6px -1px rgb(0 0 0 / 0.3)" }} />
